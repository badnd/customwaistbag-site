...
<head>
  ...
  <script src="/assets/inquiry-analytics.js" defer></script>
  <style>
...
const health = {
  ...
  analytics: {
    ...
    events: site.analytics.inquiryEvents,
    productionHostOnly: true,
    collectPii: site.analytics.collectPii
  },
...
await Promise.all([
  ...
  copyFile(resolve('static-pilot/runtime/inquiry-analytics.js'), resolve(output, 'assets/inquiry-analytics.js')),
